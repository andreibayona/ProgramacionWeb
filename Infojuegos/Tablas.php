        ...
        <section id="preguntas">
            <div class="container">
                <div id="page-wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Tabla Juegos</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_array($rec)) {
                                                echo "<tr>";
                                                echo "<td><a href='editJuegos.php?id_juego=$row[0]'>$row[0]</a></td>";
                                                echo "<td>$row[1]</td>";
                                                echo "<td>$row[4]</td>";
                                                echo "<td>$row[7]</td>";
                                                echo "<td>$row[8]</td>";
        ...
        <section id="preguntas">
            <div class="container">
                <div id="page-wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Tabla Noticias</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                                ...
                                <div class="panel-body">
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_array($rec)) {
                                                echo "<tr>";
                                                echo "<td><a href='editNoticias.php?id_noticia=$row[0]'>$row[0]</a></td>";
                                                echo "<td>$row[1]</td>";
                                                echo "<td>$row[4]</td>";
                                                echo "<td>$row[5]</td>";
