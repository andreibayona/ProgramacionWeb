                                                ...
                                                while ($row = mysqli_fetch_array($rec)) {
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" value="<?php echo $ac1; ?>" placeholder="titulo" id="titulo" name="titulo" >
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control"value="<?php echo $ac6; ?>"  placeholder="Video de youtube" id="video" name="video">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="titulo">id noticia</label>
                                                            <input class="form-control" value="<?php echo $ac; ?>" placeholder="titulo" id="titulo" name="idnoticia" readonly="">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="informacion" >información</label>
                                                            <textarea class="form-control"  name="informacion" rows="5" id="informacion" ><?php echo $ac3; ?> </textarea>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="fecha">fecha</label>
                                                            <input type="date" name="fecha" value="<?php echo $ac4; ?>"  class="form-control" id="fecha" >
                                                        </div>                                      

                                                        <div class="form-group">
                                                            <label for="Nredactor">Nombre redactor</label>
                                                            <input class="form-control" value="<?php echo $ac5; ?>"  placeholder="Nombre redactor" name="nredactor"id="Nredactor" >
                                                        </div>
                                                    <?php } ?>
                                                </div>
                                                <button type="submit" class="btn btn-default" name="editarNoticia" id="enviar">Actualizar</button>
                                                <button type="submit" class="btn btn-default" name="eliminarNoticia" id="enviar">Eliminar</button>
