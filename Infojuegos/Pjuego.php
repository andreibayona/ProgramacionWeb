        ...
        <section>   
            <div class="container">
                ...
                while ($row = mysqli_fetch_array($rec)) {
                    ...
                    <div class="col-md-2 ">
                        <img src="<?php echo $ac2; ?>" alt="" height="350px" width="300px">  
                        <div class="col-md-3 col-md-pull- ">
                            <br><br><br>
                            <p class="text-info">Precio</p>
                            <p > <span class="glyphicon glyphicon-usd"><?php echo $ac9; ?></span></p><hr>
                            <div class="ratings">
                    ...
                    <div class="col-md-7 col-md-offset-4 ">
                        <img src="<?php echo $ac5; ?>" width="780px" height="300px">
                    </div>
                ...
                <div class="col-md-3 ">
                    <p>Comprar</p>
                    <a href="<?php echo "Comprar.php?id_juego=$ac" ?>" class="btn btn-primary btn-lg "> <span class="glyphicon glyphicon-credit-card"></span> </a><br> <br><br>
                    <a href="<?php echo "Carrito.php?id_juego=$ac" ?>" class="btn btn-primary btn-lg "> <span class="glyphicon glyphicon-shopping-cart"></span> </a><br>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="comments-logout">                
                                <ul class="media-list">
                                    ...
                                    $db = new Conexion();
                                    $db->conectar();
                                    $rec = $db->consultar("comentarios", "id_juego", $id_Juego);
                                    while ($row = mysqli_fetch_array($rec)) {
                                        $ac = $row[0];
                                        $ac1 = $row[1];
                                        $ac2 = $row[2];
                                ...
                                <form action="Control.php" method="post" class="form-horizontal" id="commentForm" role="form"> 
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-1">
                                            ...
                                            <input type="hidden" class="form-control" name="idjuego" value="<?php echo $acm; ?>" readonly="">
                                            <?php } ?>
